...
void skills(){
	...
	intake.set(Intake::IntakeState::SCORE,100,100);
    chassis.pid_wait_quick();
	pros::delay(750);
	...
	chassis.pid_wait_quick();
	chassis.pid_odom_ptp_set({{25.5,-19.5},fwd,60}, true);
	chassis.pid_wait_quick();
	pros::delay(300);
	...
	chassis.pid_wait_quick();
	intake.set(Intake::SCORE,60,100);
	pros::delay(2500);
	intake.set(Intake::SCORE,40,127);
	pros::delay(1000);
