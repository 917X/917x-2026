...
void default_constants() {
	...
	chassis.pid_heading_constants_set(3.5, 0.0, 9); // 5 0 9

	// angular constants
	chassis.pid_turn_constants_set(1.8, 0.12, 11.1, 5);
	chassis.pid_swing_constants_set(3.8, 0.3, 21.25, 5);
    chassis.odom_turn_bias_set(0.9);
	chassis.pid_odom_angular_constants_set(1.8, 0.15, 11.7, 5);
	chassis.pid_odom_boomerang_constants_set(6, 0.0, 24);

	// exit conditions
	chassis.pid_turn_exit_condition_set(90_ms, 1.75_deg, 300_ms, 5_deg, 500_ms,
										500_ms);
	...
	chassis.slew_drive_constants_forward_set(5_in, 30);
	chassis.slew_drive_constants_backward_set(5_in, 30);
