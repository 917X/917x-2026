...
class Drive {
  public:
	 ...
	 *        the starting speed for the movement, 0 - 127
	 */
	void slew_swing_constants_forward_set(okapi::QLength distance,
										  int min_speed);
	 ...
	 *        the starting speed for the movement, 0 - 127
	 */
	void slew_swing_constants_backward_set(okapi::QLength distance,
										   int min_speed);
	 ...
	 *        the starting speed for the movement, 0 - 127
	 */
	void slew_swing_constants_forward_set(okapi::QAngle distance,
										  int min_speed);
	 ...
	 *        the starting speed for the movement, 0 - 127
	 */
	void slew_swing_constants_backward_set(okapi::QAngle distance,
										   int min_speed);
	 ...
	 *        the starting speed for the movement, 0 - 127
	 */
	void slew_drive_constants_backward_set(okapi::QLength distance,
										   int min_speed);
	...
	/**
	 * Sets the default slew for drive forwards and backwards motions, can be
	 * overwritten in movement functions.
	 *
	 * \param slew_on
	...
	/**
	 * Sets the default slew for drive forward motions, can be overwritten in
	 * movement functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Returns true if slew is enabled for all drive forward movements, false
	 * otherwise.
	 */
	bool slew_drive_forward_get();

	/**
	 * Sets the default slew for drive backward motions, can be overwritten in
	 * movement functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Returns true if slew is enabled for all drive backward movements, false
	 * otherwise.
	 */
	bool slew_drive_backward_get();

	/**
	 * Sets the default slew for swing forward and backward motions, can be
	 * overwritten in movement functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Sets the default slew for swing forward motions, can be overwritten in
	 * movement functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Returns true if slew is enabled for all swing forward motions, false
	 * otherwise.
	 */
	bool slew_swing_forward_get();

	/**
	 * Sets the default slew for swing backward motions, can be overwritten in
	 * movement functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Returns true if slew is enabled for all swing backward motions, false
	 * otherwise.
	 */
	bool slew_swing_backward_get();

	/**
	 * Sets the default slew for turn motions, can be overwritten in movement
	 * functions.
	 *
	 * \param slew_on
	 *        true enables, false disables
	...
	/**
	 * Allows slew to reenable when the new input speed is larger than the
	 * current speed during pure pursuits.
	 *
	 * \param slew_on
	 *        true enables, false disables
	 */
	...
	/**
	 * Returns if slew will reenable when the new input speed is larger than the
	 * current speed during pure pursuits.
	 */
	...
	Drive(std::vector<int> left_motor_ports, std::vector<int> right_motor_ports,
		...
		__attribute__((deprecated(
			"Use the integrated encoder constructor with "
			"odom_tracker_left_set() and odom_tracker_right_set() instead!")));
	 ...
	 */
	void odom_xyt_set(okapi::QLength p_x, okapi::QLength p_y,
					  okapi::QAngle p_t);
	 ...
	 *
	 * \param flip
	 *        true means counterclockwise is positive, false means clockwise is
	 * positive
	 */
	 ...
	 * Sets a new dlead.
	 *
	 * Dlead is a proportional value of how much to make the robot curve during
	 * boomerang motions.
	 *
	 * \param input
	 ...
	 *
	 * Turning is prioritized so the robot "applies brakes" while turning. Lower
	 * number means more braking.
	 *
	 * \param bias
	...
	/**
	 * Returns the proportion of how prioritized turning is during odometry
	 * motions.
	 */
	...
	/**
	 * Returns the spacing between points when points get injected into the
	 * path.
	 */
	 ...
	 */
	void odom_path_smooth_constants_set(double weight_smooth,
										double weight_data, double tolerance);
	...
	/**
	 * Gives some wiggle room in shortest vs longest, so a 180.1 and 179.9
	 * degree turns have consistent behavior.
	 *
	 * \param p_tolerance
	...
	/**
	 * Returns the wiggle room in shortest vs longest, so a 180.1 and 179.9
	 * degree turns have consistent behavior.
	 */
	...
	/**
	 * Returns the behavior when a turn is within its tolerance, you can have it
	 * bias left or right.
	 */
	 ...
	 * Run in usercontrol.
	 *
	 * This passes the controller through the curve functions, but is disabled
	 * by default. Use opcontrol_curve_buttons_toggle() to enable it.
	 */
	void opcontrol_tank();

	/**
	 * Sets the chassis to controller joysticks using standard arcade control,
	 * where left stick is fwd/rev. Run in usercontrol.
	 *
	 * This passes the controller through the curve functions, but is disabled
	 * by default. Use opcontrol_curve_buttons_toggle() to enable it.
	 *
	 ...
	 * where right stick is fwd/rev. Run in usercontrol.
	 *
	 * This passes the controller through the curve functions, but is disabled
	 * by default. Use opcontrol_curve_buttons_toggle() to enable it.
	 *
	...
	/**
	 * Initializes left and right curves with the SD card, recommended to run in
	 * initialize().
	 */
	 ...
	 */
	void opcontrol_drive_activebrake_set(double kp, double ki = 0.0,
										 double kd = 0.0, double start_i = 0.0);
	...
	/**
	 * Gets the current state of the toggle. Enables/disables modifying the
	 * joystick input curves with the controller.
	 *
	 ...
	 */
	void
	opcontrol_curve_buttons_left_set(pros::controller_digital_e_t decrease,
									 pros::controller_digital_e_t increase);

	/**
	 * Returns a vector of pros controller buttons user for the left joystick
	 * curve, in {decrease, increase}
	 */
	 ...
	 */
	void
	opcontrol_curve_buttons_right_set(pros::controller_digital_e_t decrease,
									  pros::controller_digital_e_t increase);

	/**
	 * Returns a vector of pros controller buttons user for the right joystick
	 * curve, in {decrease, increase}
	 */
	std::vector<pros::controller_digital_e_t>
	 ...
	 *
	 * If you have two parallel tracking wheels, this will return tracking wheel
	 * position.  Otherwise this returns motor position.
	 */
	...
	/**
	 * Reset all the chassis motors and tracking wheels, recommended to run at
	 * the start of your autonomous routine.
	 */
	void drive_sensor_reset();

	/**
	 * Resets the current imu value.  Defaults to 0, recommended to run at the
	...
	/**
	 * Checks if the imu calibrated successfully or if it took longer than
	 * expected.
	 *
	...
	/**
	 * Practice mode for driver practice that shuts off the drive if you go max
	 * speed.
	 *
	 * \param toggle
	 *        true enables, false disables
	...
	/**
	 * Reversal for drivetrain in opcontrol that flips the left and right side
	 * and the direction of the drive.
	 *
	 * \param toggle
	...
	/**
	 * Sets the robot to move forward using PID with okapi units, only using
	 * slew if globally enabled.
	 *
	 * This function is actually odom
	 *
	...
	/**
	 * Takes in an odom movement to go to a single point.  If an angle is set,
	 * this will run boomerang.  Uses slew if globally enabled.
	 *
	 * \param imovement
	...
	/**
	 * Takes in an odom movement to go to a single point.  If an angle is set,
	 * this will run boomerang.  Uses slew if enabled for this motion.
	 *
	 * \param imovement
	 *        {{x, y, t}, fwd/rev, 1-127}  an odom movement
	 * \param slew_on
	 ...
	 * angle is set, this will run boomerang.  Uses slew if globally enabled.
	 *
	 * \param imovement
	 *        {{x, y, t}, fwd/rev, 1-127}  an odom movement
	 */
	...
	/**
	 * Takes in an odom movement to go to a single point using boomerang.  If an
	 * angle is set, this will run boomerang.  Uses slew if enabled for this
	 * motion.
	 *
	 * \param imovement
	 *        {{x, y, t}, fwd/rev, 1-127}  an odom movement
	 ...
	 *
	 * \param imovement
	 *        {{x, y, t}, fwd/rev, 1-127}  an odom movement.  values are united
	 * here with okapi units
	 */
	...
	/**
	 * Takes in odom movements to go through multiple points, will inject and
	 * smooth the path.  If an angle is set, this will run boomerang for that
	 * point.  Uses slew if globally enabled.
	 *
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	 * movements
	 */
	 ...
	 * Takes in odom movements to go through multiple points, will inject and
	 * smooth the path.  If an angle is set, this will run boomerang for that
	 * point.  Uses slew if enabled for this motion.
	 *
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	 * movements
	...
	/**
	 * Takes in odom movements to go through multiple points.  If an angle is
	 * set, this will run boomerang for that point.  Uses slew if globally
	 * enabled.
	 *
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	...
	/**
	 * Takes in odom movements to go through multiple points.  If an angle is
	 * set, this will run boomerang for that point.  Uses slew if enabled for
	 * this motion.
	 *
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	...
	/**
	 * Takes in odom movements to go through multiple points, will inject into
	 * the path.  If an angle is set, this will run boomerang for that point.
	 ...
	 * Takes in odom movements to go through multiple points, will inject into
	 * the path.  If an angle is set, this will run boomerang for that point.
	 * Uses slew if enabled for this motion.
	 *
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	 * movements
	 ...
	 * \param imovements
	 *        {{{x, y, t}, fwd/rev, 1-127}, {{x, y, t}, fwd/rev, 1-127}}  odom
	 * movements.  values are united here with okapi units
	 */
	 ...
	 *        0 to 127, max speed during motion
	 * \param behavior
	 *        changes what direction the robot will turn.  can be left, right,
	 * shortest, longest, raw
	 */
	void pid_turn_set(pose itarget, drive_directions dir, int speed,
	...
	/**
	 * Sets the robot to turn relative to initial heading using PID, using slew
	 * if enabled for this motion.
	 *
	 * \param target
	 *        target value as a double, unit is degrees
	...
	/**
	 * Sets the robot to turn relative to initial heading using PID with okapi
	 * units.
	 *
	 * \param p_target
	...
	/**
	 * Sets the robot to turn relative to initial heading using PID with okapi
	 * units, using slew if enabled for this motion.
	 *
	 * \param p_target
	 *        target value in okapi angle units
	 * \param speed
	...
	/**
	 * Sets the robot to turn relative to current heading using PID with okapi
	 * units, only using slew if globally enabled.
	 *
	 * \param p_target
	 *        target value in okapi angle units
	 * \param speed
	...
	/**
	 * Sets the robot to turn relative to current heading using PID without
	 * okapi units, only using slew if globally enabled.
	 *
	 * \param p_target
	 *        target value as a double, unit is degrees
	 * \param speed
	...
	/**
	 * Sets the robot to turn relative to current heading using PID without
	 * okapi units, using slew if enabled for this motion.
	 *
	 * \param p_target
	 *        target value as a double, unit is degrees
	 * \param speed
	...
	/**
	 * Sets the robot to turn using only the left or right side relative to
	 * initial heading without okapi units, only using slew if globally enabled.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	 * \param target
	...
	/**
	 * Sets the robot to turn using only the left or right side relative to
	 * initial heading without okapi units, using slew if enabled for this
	 * motion.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	 ...
	 * the swing. this is used for arcs, and is defaulted to 0
	 */
	void pid_swing_set(e_swing type, double target, int speed,
					   int opposite_speed);
	 ...
	 */
	void pid_swing_set(e_swing type, double target, int speed,
					   int opposite_speed, e_angle_behavior behavior);
	 ...
	 */
	void pid_swing_set(e_swing type, double target, int speed,
					   int opposite_speed, bool slew_on);
	...
	/**
	 * Sets the robot to turn using only the left or right side relative to
	 * initial heading with okapi units, only using slew if globally enabled.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	 * \param p_target
	...
	/**
	 * Sets the robot to turn using only the left or right side relative to
	 * initial heading with okapi units, using slew if enabled for this motion.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	 * \param p_target
	...
	/**
	 * Sets the robot to turn only using the left or right side relative to
	 * initial heading using PID with okapi units, using slew if enabled for
	 * this motion.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	...
	/**
	 * Sets the robot to turn only using the left or right side relative to
	 * current heading using PID with okapi units, only using slew if globally
	 * enabled.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	 ...
	 *        0 to 127, max speed during motion
	 */
	void pid_swing_relative_set(e_swing type, okapi::QAngle p_target,
								int speed);
	...
	/**
	 * Sets the robot to turn only using the left or right side relative to
	 * current heading using PID with okapi units, using slew if enabled for
	 * this motion.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	...
	/**
	 * Sets the robot to turn only using the left or right side relative to
	 * current heading using PID without okapi units, only using slew if
	 * globally enabled.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	...
	/**
	 * Sets the robot to turn only using the left or right side relative to
	 * current heading using PID without okapi units, using slew if enabled for
	 * this motion.
	 *
	 * \param type
	 *        L_SWING or R_SWING
	...
	/**
	 * Lock the code in a while loop until this position has passed for turning
	 * or swinging with okapi units.
	 *
	 * \param target
	...
	/**
	 * Lock the code in a while loop until this position has passed for driving
	 * with okapi units.
	 *
	 * \param target
	 ...
	 *
	 * \param target
	 *        for driving or turning, using a double.  degrees for turns/swings,
	 * inches for driving
	 */
	 ...
	 * Lock the code in a while loop until the robot has settled.
	 *
	 * Wrapper for pid_wait_until(target), target is your previously input
	 * target.
	 */
	void pid_wait_quick();
	 ...
	 *
	 * \param target
	 *        {x, y} pose for the robot to pass through before the while loop is
	 * released
	 */
	void pid_wait_until_point(pose target);

	/**
	 * Lock the code in a while loop until this point has been passed, with
	 * okapi units.
	 *
	 * \param target
	 *        {x, y} pose with units for the robot to pass through before the
	 * while loop is released
	 */
	 ...
	 *
	 * \param target
	 *        {x, y}  a pose for the robot to pass through before the while loop
	 * is released
	 */
	 ...
	 *
	 * \param target
	 *        {x, y}  a pose with units for the robot to pass through before the
	 * while loop is released
	 */
	...
	/**
	 * Sets the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion.
	 *
	...
	/**
	 * Returns the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion for turning.
	 */
	 ...
	 *        error threshold to start integral
	 */
	void pid_swing_constants_set(double p, double i = 0.0, double d = 0.0,
								 double p_start_i = 0.0);
	 ...
	 *        error threshold to start integral
	 */
	void pid_swing_constants_forward_set(double p, double i = 0.0,
										 double d = 0.0,
										 double p_start_i = 0.0);
	 ...
	 *        error threshold to start integral
	 */
	void pid_swing_constants_backward_set(double p, double i = 0.0,
										  double d = 0.0,
										  double p_start_i = 0.0);
	...
	/**
	 * Returns the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion for swinging forward.
	 */
	...
	/**
	 * Returns the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion for swinging backward.
	 */
	 ...
	 *        error threshold to start integral
	 */
	void pid_heading_constants_set(double p, double i = 0.0, double d = 0.0,
								   double p_start_i = 0.0);
	 ...
	 *        error threshold to start integral
	 */
	void pid_drive_constants_set(double p, double i = 0.0, double d = 0.0,
								 double p_start_i = 0.0);
	 ...
	 *        error threshold to start integral
	 */
	void pid_drive_constants_backward_set(double p, double i = 0.0,
										  double d = 0.0,
										  double p_start_i = 0.0);
	...
	/**
	 * Returns the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion for driving forward.
	 */
	...
	/**
	 * Returns the amount that the PID will overshoot target by to maintain
	 * momentum into the next motion for driving backward.
	 */
	 ...
	 *        error threshold to start integral
	 */
	void pid_odom_angular_constants_set(double p, double i = 0.0,
										double d = 0.0, double p_start_i = 0.0);
	 ...
	 *        error threshold to start integral
	 */
	void pid_odom_boomerang_constants_set(double p, double i = 0.0,
										  double d = 0.0,
										  double p_start_i = 0.0);
	 ...
	 * \param p_mA_timeout
	 *        mA timer will start when the motors are pulling too much current,
	 * in ms
	 * \param use_imu
	 *        true adds the imu for velocity calculation in conjunction with the
	 * main sensor, false doesn't
	 */
	void pid_odom_drive_exit_condition_set(
		int p_small_exit_time, double p_small_error, int p_big_exit_time,
		double p_big_error, int p_velocity_exit_time, int p_mA_timeout,
		bool use_imu = true);
	 ...
	 * main sensor, false doesn't
	 */
	void pid_odom_turn_exit_condition_set(
		int p_small_exit_time, double p_small_error, int p_big_exit_time,
		double p_big_error, int p_velocity_exit_time, int p_mA_timeout,
		bool use_imu = true);
	 ...
	 * main sensor, false doesn't
	 */
	void pid_odom_turn_exit_condition_set(okapi::QTime p_small_exit_time,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_odom_drive_exit_condition_set(okapi::QTime p_small_exit_time,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_drive_exit_condition_set(okapi::QTime p_small_exit_time,
									  okapi::QLength p_small_error,
									  okapi::QTime p_big_exit_time,
									  okapi::QLength p_big_error,
									  okapi::QTime p_velocity_exit_time,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_turn_exit_condition_set(okapi::QTime p_small_exit_time,
									 okapi::QAngle p_small_error,
									 okapi::QTime p_big_exit_time,
									 okapi::QAngle p_big_error,
									 okapi::QTime p_velocity_exit_time,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_swing_exit_condition_set(okapi::QTime p_small_exit_time,
									  okapi::QAngle p_small_error,
									  okapi::QTime p_big_exit_time,
									  okapi::QAngle p_big_error,
									  okapi::QTime p_velocity_exit_time,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_drive_exit_condition_set(int p_small_exit_time,
									  double p_small_error, int p_big_exit_time,
									  double p_big_error,
									  int p_velocity_exit_time,
									  int p_mA_timeout, bool use_imu = true);
	 ...
	 * main sensor, false doesn't
	 */
	void pid_turn_exit_condition_set(int p_small_exit_time,
									 double p_small_error, int p_big_exit_time,
									 double p_big_error,
	 ...
	 * main sensor, false doesn't
	 */
	void pid_swing_exit_condition_set(int p_small_exit_time,
									  double p_small_error, int p_big_exit_time,
									  double p_big_error,
									  int p_velocity_exit_time,
									  int p_mA_timeout, bool use_imu = true);
	 ...
	 *
	 * \param enable
	 *        true will enable the full PID tuner, false will use the simplified
	 * PID tuner
	 */
	 ...
	 *
	 * True means the full PID tuner is enabled, false means the simplified PID
	 * tuner is enabled.
	 */
	...
	/**
	 * Returns if vector scaling for arcade control is enabled.  True enables,
	 * false disables.
	 */
  ...
  private:
	...
	int pp_index = 0;
	std::vector<odom> smooth_path(std::vector<odom> ipath, double weight_smooth,
								  double weight_data, double tolerance);
	...
	double new_turn_target_compute(double target, double current,
	...
	std::pair<float, float> decide_vert_sensor(ez::tracking_wheel *tracker,
											   bool is_tracker_enabled,
											   float ime = 0.0,
											   float ime_track = 0.0);
	pose solve_xy_vert(float p_track_width, float current_t, float delta_vert,
					   float delta_t);
	pose solve_xy_horiz(float p_track_width, float current_t, float delta_horiz,
						float delta_t);
	...
	float p_increment = 0.1, i_increment = 0.001, d_increment = 0.25,
		  start_i_increment = 1.0;
